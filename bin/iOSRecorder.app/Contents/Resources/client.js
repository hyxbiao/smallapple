...
try {
    ...
    while(!isEnd){
        ...
        var result = host.performTaskWithPathArgumentsTimeout("/bin/sh",["/Users/hyxbiao/dep/git/github.com/smallapple/bin//iOSRecorder.app/Contents/Resources/TcpSocket.sh"],5);
